...
#Add count at end of filehash check, same as used in blacklist check
...
while repeat == 'y':
            ...
            if detections >= 1:
                ...
                for vendor in scan_results:
                    if scan_results[vendor]['detected']:
                        ...
                        print(colour.RED + '{!s}, {!s}'.format(vendor, detected_name + colour.END))
            else:
    ...
    if __name__ == "__main__":
        ...
        print(colour.BOLD + '----- Geolocation IP Information ----- \n' + colour.END)
        print(geoip)
        print(colour.BOLD + '\n----- Blacklist Check ------\n' + colour.END)
