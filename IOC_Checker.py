...
while repeat == 'y':
    ...
    layout = [[sg.Text("Please provide the IP/File Hash you wish to check:")],
              [sg.InputText()],
    ...
    apikey = ("<API>") #Insert API key here
    ...
    ################################ OPSWAT File Hash Check - https://metadefender.opswat.com/?lang=en ################################
        ...
        headers = {
            'apikey': "<API Key>" #Insert API key here
        }
    ...
    ################################ JSON Parse ################################
        ...
        headers = {
            ...
            'Key': '<API Key>' #Insert API key here
        }
